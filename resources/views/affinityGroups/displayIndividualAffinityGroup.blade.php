...
@section('content')
    <h1 style="text-align: center;font-size: 36px;color: var(--primary);margin-top: 29px;">{{ $affinity->getAffinityGroupName() }} Members</h1>
    @if ($user_array)
    ...
    @endforeach
    @else
        <h2 style="text-align: center;font-size: 36px;color: var(--primary);margin-top: 100px;">Currently No Users Available</h2>
    @endif
@endsection
